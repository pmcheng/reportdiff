...
if (file.exists("~/Radiology USC/reportdiff/core/powerscribe/reportdiff_ps.db")) {
  setwd("~/Radiology USC/reportdiff/core/analysis")
} else {
  setwd("e:/Radiology USC/reportdiff/core/analysis")
}
con = dbConnect(drv, "../powerscribe/reportdiff_ps.db")
...
dbGetQuery(con, "attach '../powerscribe/users.db' as users")
